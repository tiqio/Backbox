...
func TestHTTPSourceAddress(t *testing.T) {
	...
	for i, test := range testcases {
		...
		result := ProbeHTTP(testCTX, "baidu.com", config.Module{Prober: "http", Timeout: time.Second, HTTP: config.HTTPProbe{IPProtocolFallback: true, Method: "GET"}}, registry, promslog.NewNopLogger())
